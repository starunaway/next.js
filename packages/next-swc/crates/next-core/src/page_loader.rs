...
use turbopack_binding::{
    ...
    turbopack::{
        core::{
            ...
            chunk::{
                ChunkData, ChunkableAsset, ChunkingContext, ChunksData, EvaluatableAsset,
                EvaluatableAssets,
            },
...
pub struct PageLoaderAsset {
    ...
    pub entry_asset: Vc<Box<dyn Asset>>,
...
impl PageLoaderAsset {
    #[turbo_tasks::function]
    async fn get_page_chunks(self: Vc<Self>) -> Result<Vc<Assets>> {
        let this = &*self.await?;
