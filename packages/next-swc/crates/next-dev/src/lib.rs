...
use next_core::{
    ...
    next_image::NextImageContentSource, pages_structure::find_pages_structure,
    router_source::NextRouterContentSource, source_map::NextSourceMapTraceContentSource,
};
...
async fn source(
    ...
    let viz = Vc::upcast(
        turbo_tasks_viz::TurboTasksSource {
